...
tf.compat.v1.app.flags.DEFINE_integer('num_examples', 134, """Number of examples to run.""")
...
def get_representations():
  with tf.Graph().as_default():
    ...
    # Build a Graph that computes the logits predictions from the
    # inference model.
    _, _, fuse = resnet50.inference(image, tf.zeros([1,81,121,resnet50_input.NUM_CLASSES]), tf.zeros([1,81,121,resnet50_input.NUM_CLASSES]))
